...
{
    public class ProjectStatusService : BaseService<Model.ProjectStatus, Database.ProjectStatus, ProjectStatusSearchObject>, IProjectStatusService
    {
        public ProjectStatusService(SolarnessDbContext context, IMapper mapper):base(context,mapper)
        {
        }
    }
}
