...
{
    public class SolarPanelService : BaseService<Model.SolarPanel, Database.SolarPanel, SolarPanelSearchObject>, ISolarPanelService
    {
        public SolarPanelService(SolarnessDbContext context, IMapper mapper):base(context,mapper)
        {
        }
    }
}
