...
{
    public class TaskService : BaseCRUDService<Model.Task, Database.Task, TaskSearchObject, TaskInsertRequest, TaskUpdateRequest>, ITaskService
    {
        public TaskService(SolarnessDbContext context, IMapper mapper):base(context,mapper)
        {
        }
    }
}
