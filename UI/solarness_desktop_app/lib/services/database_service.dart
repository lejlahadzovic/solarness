...
import 'package:solarness_desktop_app/models/Chat/chat.dart';
...
class DatabaseService {
  ...
  Future<void> createUserProfile({required User korisnik}) async {
    await _usersCollection?.doc(korisnik.userId.toString()).set(korisnik);
  }
